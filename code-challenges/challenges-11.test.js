...
const validateEmail = (element) => {
  // Solution code here...
  let reg = /^(((([a-z]*[0-9]*)*\.)?)([a-z]*[0-9]*)\w+)\@([a-z]*[0-9]*)\.(com||net||org)$/g;
...
const validatePhoneNumber = (phoneNumber) => {
  // Solution code here...
  let reg = /^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})*(?:[-])?([0-9]{4})$|^[0-9][0-9][0-9]\s[0-9][0-9][0-9]\s[0-9][0-9][0-9][0-9]$/g
