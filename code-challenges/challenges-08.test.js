...
function returnTen(str){
  // Solution code here...
  const n = 10;
  let word = str.substring(str.length - n)
  let wordTow = word.split('');
 return(wordTow);
